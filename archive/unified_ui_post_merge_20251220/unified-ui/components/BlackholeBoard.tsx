...
import { Plus, Search, Filter, GitBranch, AlertCircle, GitCommit, GitPullRequest, Clock } from 'lucide-react';
...
const BlackholeBoard: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-amber-100 overflow-hidden relative" data-testid="blackhole-board" ref={containerRef}>
      <BlackholeBackground />
